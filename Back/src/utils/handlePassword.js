...
const encrypt = (passwordPlain) => __awaiter(void 0, void 0, void 0, function* () {
    let password;
    const hash = yield bcrypt_1.default.hash(passwordPlain, 10).then(res => password = res);
    return password;
});
exports.encrypt = encrypt;
const comparePassword = (myPlaintextPassword, hashPassword) => __awaiter(void 0, void 0, void 0, function* () {
    let password;
    yield bcrypt_1.default.compare(myPlaintextPassword, hashPassword).then(res => password = res);
    return password;
});
